...
var PostController = /** @class */ (function () {
    ...
    PostController.prototype.findForStatus = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var posts, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        addPost = _a.sent();
                        return [2 /*return*/, res.json(addPost)];
                    case 2:
                        error_3 = _a.sent();
    ...
    PostController.prototype.remove = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var idEncontrado, deletePost, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        idEncontrado = req.params.id;
                        return [4 /*yield*/, Post_1["default"].findOneAndDelete({ _id: idEncontrado })];
                    case 1:
                        deletePost = _a.sent();
                        return [2 /*return*/, res.json(deletePost)];
                    case 2:
                        error_4 = _a.sent();
    ...
    PostController.prototype.update = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var idEncontrado, newPost, updatePost, error_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        ...
                        return [4 /*yield*/, Post_1["default"].updateOne({ _id: idEncontrado }, newPost)];
                    case 1:
                        updatePost = _a.sent();
                        return [2 /*return*/, res.json(updatePost)];
                    case 2:
                        error_5 = _a.sent();
